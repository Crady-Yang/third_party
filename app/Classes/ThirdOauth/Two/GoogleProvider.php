...
namespace App\Classes\ThirdOauth\Two;

use Illuminate\Support\Arr;
use App\Classes\ThirdOauth\ThirdProvider as ProviderInterface;
...
class GoogleProvider extends AbstractProvider implements ProviderInterface
{
    ...
    {
        $u = $this->buildAuthUrlFromBase('https://accounts.google.com/o/oauth2/auth', $state);
        return $u;
    }
